# [SOLVED] Error 2006 Error Error 2006 Hy000 Mysql Server Has Gone Away
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/error-2006-error-error-2006-hy000-mysql-server-has-gone-away)

---

### 🔍 Quick Technical Overview & Summary:
Check the MySQL query limit and increase it using the `set session variable` command, or consider using a more efficient method to import the data, such as using `LOAD DATA INFILE` instead of `SOURCE FILE`.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/error-2006-error-error-2006-hy000-mysql-server-has-gone-away)**
